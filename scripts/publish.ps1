...
if ($Target.Equals("Debug")) {
    ...
    Copy-Item -Path "$TargetPath\$name.pdb" -Destination "$plug" -Force -ErrorAction SilentlyContinue
    Copy-Item -Path "$TargetPath\$name.dll.mdb" -Destination "$plug" -Force -ErrorAction SilentlyContinue
}
